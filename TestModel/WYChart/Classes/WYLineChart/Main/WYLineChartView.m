...
- (void)updateGraph {
    ...
    x = 0;//_calculator.yAxisViewWidth;
    ...
    _contentScrollView.contentInset =UIEdgeInsetsMake(0, -10, 0, -10);
    ...
    height = CGRectGetHeight(self.bounds);
    frame = CGRectMake(self.frame.size.width *0.5 , 0, _calculator.yAxisViewWidth, height);
